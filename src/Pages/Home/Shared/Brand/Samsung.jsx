                            ...
                            <div style={{ height: "16.5rem" }} className="p-5 bg-amber-200 hover:bg-slate-200 duration-200 rounded-md flex">
                                ...
                                <div className="p-5 flex flex-col justify-between bg-yellow-400 hover:bg-yellow-300 duration-300 h-full rounded-r-md w-full">
                                    ...
                                    <div className="flex gap-2">
                                        <Link to={`/productDetailsSamsung/${product._id}`}><button className="bg-green-500 hover:bg-green-600 duration-200 px-7 py-1 rounded mt-1 font-medium">Details</button></Link>
                                        <Link to={`/updateSamsung/${product._id}`}><button className="bg-green-500 hover:bg-green-600 duration-200 px-7 py-1 rounded mt-1 font-medium">Update</button></Link>
                                    </div>
                                </div>
                            </div>
                        </div>)

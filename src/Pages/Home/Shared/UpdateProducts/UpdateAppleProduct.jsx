...
const UpdateAppleProduct = () => {
    ...
    const [brand, setBrand] = useState(apple.brand);
    const [productType, setProductType] = useState(apple.productType);
                ...
                <div className="md:w-1/2 mx-auto shadow-xl">
                    ...
                    <form onSubmit={handleUpdateProduct} className="px-8 card-body">
                        <div className="form-control">
                            ...
                            <input type="text" name="name" defaultValue={apple.name} placeholder="Enter Product Name" className="input bg-white input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Product Price</span>
                            </label>
                            <input type="text" name="price" defaultValue={apple.price} placeholder="Enter Product Price" className="input bg-white input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Product Description</span>
                            </label>
                            <input type="text" name="description" defaultValue={apple.description} placeholder="Enter Product Description" className="input bg-white input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Product Rating</span>
                            </label>
                            <input type="text" name="rating" defaultValue={apple.rating} placeholder="Enter Product Rating" className="input bg-white input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Product Photo URL</span>
                            </label>
                            <input type="text" name="photo" defaultValue={apple.URL} placeholder="Enter Product Photo URL" className="input bg-white input-bordered" />
                        </div>
                        <label className="label">
...
export default UpdateAppleProduct;